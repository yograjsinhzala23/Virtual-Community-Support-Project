    ...
    const currentUserSubscribe = this._service
      ...
      .subscribe((data: any) => {
        ...
        if (userName != null || data != null) {
          ...
          data == null
            ? (this.userImage = userName.userImage ? this._service.imageUrl + '/' + userName.userImage : 'assets/NoUser.png')
            : (this.userImage = data.userImage ? this._service.imageUrl + '/' + data.userImage : 'assets/NoUser.png');
        }
      });

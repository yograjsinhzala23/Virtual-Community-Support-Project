...
export class MissionService {
  ...
  missionApplicationDelete(id: number) {
    console.log('Deleting mission application with ID:', id);
    return this.http.delete(`${this.apiUrl}${API_ENDPOINTS.MISSION.APPLICATION_DELETE}/${id}`);
  }
  ...
  // }
missionApplicationApprove(id: number) {
  return this.http.post(`${this.apiUrl}${API_ENDPOINTS.MISSION.APPLICATION_APPROVE}`, id);
}
